...
const getCountryData = (countryNameParam) => {
	...
	const nullReturn = {
		...
		lat: 0,
		long: 0,
		flag: 'https://raw.githubusercontent.com/Joralmo/API/master/assets/flags/unknow.png'
	};
	...
	if (countryFound) {
		return {
			...
			flag: `https://raw.githubusercontent.com/Joralmo/API/master/assets/flags/${countryFound.iso2.toLowerCase()}.png`
		};
	}
	return nullReturn;
};
